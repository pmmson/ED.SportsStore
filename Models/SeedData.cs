    ...
    public static class SeedData
    {
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
                ...
                new Product { Name = "Kayak", Description = "А boat for one person", Category = "Watersports", Price = 275 },
                new Product { Name = "Lifejacket", Description = "Protective and fashionabe", Category = "Watersports", Price = 48.95m },
                ...
                new Product { Name = "Thinking Сар", Description = "Improve brain efficiency bу 75%", Category = "Chess", Price = 16 },
